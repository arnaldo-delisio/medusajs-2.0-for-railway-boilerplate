            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="relative h-full flex items-center transition-all ease-out duration-200 text-white hover:text-gray-200 focus:outline-none"
                >
                  Menu
                </Popover.Button>
              </div>
              ...
              >
                <Popover.Panel className="flex flex-col absolute w-full pr-4 sm:pr-0 sm:w-1/3 2xl:w-1/4 sm:min-w-min h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-white m-2 backdrop-blur-2xl">
                  <div
                    ...
                    className="flex flex-col h-full bg-[rgba(3,7,18,0.8)] rounded-rounded justify-between p-6"
                  >
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small text-gray-200">
