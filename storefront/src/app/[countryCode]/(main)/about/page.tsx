  ...
  return (
    <div className="py-12">
      ...
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-medium mb-8">Welcome to KIAIA</h2>
        ...
        >
          ...
          >
            <Image
              src={`https://${process.env.NEXT_PUBLIC_MINIO_ENDPOINT}/medusa-media/about/philosophy.jpg`}
        ...
        >
          <motion.div 
            variants={fadeIn}
            className="relative h-[500px] rounded-lg overflow-hidden shadow-2xl md:order-2"
          >
            <Image
              src={`https://${process.env.NEXT_PUBLIC_MINIO_ENDPOINT}/medusa-media/about/craftsmanship.jpg`}
              alt="KIAIA Craftsmanship"
              fill
              className="object-cover hover:scale-105 transition-transform duration-700"
            />
          </motion.div>
          <motion.div variants={slideIn} className="md:order-1">
